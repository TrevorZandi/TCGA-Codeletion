...
### 1. Updated `data/cbioportal_client.py`
...
## Files Modified
- `data/cbioportal_client.py` - NCBI integration for genomic positions
- `data/queries.py` - Added chromosome column, updated docstrings
